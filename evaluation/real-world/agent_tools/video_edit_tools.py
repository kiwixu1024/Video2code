...
if __name__ == "__main__":
    # 替换为你想要测试的本地视频路径
    TEST_VIDEO_PATH = "/workspace/code_data/video2code_data/raw_datas_v2/htmls_v3_all/videos/141.mp4" 
    
    if os.path.exists(TEST_VIDEO_PATH):
        # print_interval=0.2 表示每 0.2 秒打印一次常规状态，你可以根据需要调小或调大
        test_video_status_detailed(TEST_VIDEO_PATH, only_green=False, print_interval=0.5)
    else:
        print(f"[提示] 请将 TEST_VIDEO_PATH 修改为实际存在的视频文件路径 (当前路径: {TEST_VIDEO_PATH})")